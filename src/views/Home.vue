                ...
                <el-row>
                  ...
                  <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
                    ...
                    <p>
                      ...
                      or kantorów wspólnot <strong>neokatechumenalnych</strong> i
                    ...
                    <div>
                      ...
                      <ul>
                        <li>lista wszystkich pieśni wraz z ich nagraniami i tekstami</li>
                        <li>możliwość wyszukiwania pieśni po tytule</li>
